...
const Gallery = () => {
    ...
    return ( 
        ...
        <div className="">
          ...
          <div className="flex grid-cols-4 gap-3 px-8 mx-auto overflow-scroll cursor-pointer lg:overflow-hidden snap-x snap-mandatory md:grid md:px-0 w-100 md:w-2/3">
            {allImage.map((item) => (
